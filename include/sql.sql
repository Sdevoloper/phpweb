...
INSERT INTO `basic_setup` (`id`, `title`, `description`, `keyword`,`author`,`gcode`,`web`, `icon`) VALUES
(1, 'Alex Smith', 'i am a web developer, i make website and php web portals .', 'web development,php development','sun','asgdg6dg66gd6','mostakahmad.xyz', 'bacola-logo-mobile.png');
